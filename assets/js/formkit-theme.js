...
export default {
    ...
    global: {
        ...
        prefixIcon:
            'w-10 flex self-stretch grow-0 shrink-0 rounded-tl rounded-bl border-r border-gray-400 bg-white [&>svg]:w-full [&>svg]:max-w-[1em] [&>svg]:max-h-[1em] [&>svg]:m-auto',
        suffixIcon:
    ...
    'family:box': {
        decorator:
            'block relative h-4 w-4 mr-2 rounded bg-white ring-1 ring-gray-300 peer-checked:ring-indigo-500 text-transparent peer-checked:text-indigo-500',
        decoratorIcon:
    ...
    'family:button': {
        input:
            '$reset inline-flex items-center bg-indigo-600 text-white text-sm font-normal py-3 px-6 rounded focus-visible:outline-2 focus-visible:outline-indigo-600 focus-visible:outline-offset-2 formkit-disabled:bg-gray-400 formkit-loading:before:w-4 formkit-loading:before:h-4 formkit-loading:before:mr-2 formkit-loading:before:border formkit-loading:before:border-2 formkit-loading:before:border-r-transparent formkit-loading:before:rounded-3xl formkit-loading:before:border-white formkit-loading:before:animate-spin',
        wrapper: 'mb-1',
    ...
    'family:dropdown': {
        ...
        inner:
            'max-w-md relative flex ring-1 ring-gray-300 focus-within:ring-indigo-500 focus-within:ring-2 rounded mb-2 formkit-disabled:focus-within:ring-gray-300 formkit-disabled:focus-within:ring-1 [&>span:first-child]:focus-within:text-indigo-500',
        input: 'w-full px-3 py-2',
        listbox: 'bg-white shadow-lg rounded overflow-hidden',
        listboxButton: 'flex w-12 self-stretch justify-center mx-auto',
        listitem:
            'pl-7 relative hover:bg-gray-300 data-[is-active="true"]:bg-gray-300 aria-selected:bg-indigo-600 aria-selected:text-white data-[is-active="true"]:aria-selected:bg-indigo-600 data-[is-active="true"]:aria-selected:bg-indigo-700',
        loaderIcon: 'ml-auto',
        loadMoreInner:
            'flex items-center justify-center text-sm p-2 text-center w-full text-indigo-500 formkit-loading:text-gray-500 cursor-pointer [&>span]:mr-3 [&>span]:ml-0',
        option: 'p-2.5',
    ...
    'family:text': {
        inner:
            'flex items-center max-w-md ring-1 ring-gray-300 focus-within:ring-indigo-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-indigo-500 rounded mb-1',
        input:
    ...
    file: {
        ...
        fileRemove:
            'relative z-[2] ml-auto text-[0px] hover:text-red-500 pl-2 peer-data-[has-multiple=true]:text-sm peer-data-[has-multiple=true]:text-indigo-500 peer-data-[has-multiple=true]:ml-3 peer-data-[has-multiple=true]:mb-2 formkit-multiple:bottom-[0.15em] formkit-multiple:pl-0 formkit-multiple:ml-0 formkit-multiple:left-[1em] formkit-multiple:formkit-prefix-icon:left-[3.75em]',
    ...
    select: {
        inner:
            'flex relative max-w-md items-center rounded mb-1 ring-1 ring-gray-300 focus-within:ring-indigo-500 focus-within:ring-2 [&>span:first-child]:focus-within:text-indigo-500',
        input:
    ...
    textarea: {
        inner:
            'flex max-w-md rounded mb-1 ring-1 ring-gray-300 focus-within:ring-indigo-500 [&>label:first-child]:focus-within:text-indigo-500',
        input:
    ...
    datepicker: {
      ...
      focus:outline focus:outline-2 focus:outline-indigo-500 focus:outline-offset-2 focus:bg-white focus:text-black
    ...
    `,
        timeInput:
            'w-full border-2 border-gray-300 rounded-md p-2 my-[2em] focus-visible:outline-indigo-500',
        ...
        dayButton:
            'appearance-none cursor-pointer px-3 py-1 border-2 rounded-lg mx-1 hover:border-indigo-500',
        monthButton:
            'appearance-none cursor-pointer px-3 py-1 border-2 rounded-lg mx-1 hover:border-indigo-500',
        yearButton:
            'appearance-none cursor-pointer px-3 py-1 border-2 rounded-lg mx-1 hover:border-indigo-500',
    ...
    repeater: {
        ...
        downControl:
            'hover:text-indigo-500 disabled:hover:text-inherit disabled:opacity-25',
        fieldset: 'py-4 px-5',
        help: 'mb-2 mt-1.5',
    ...
    slider: {
        ...
        handle:
            'group w-4 h-4 rounded-full bg-white absolute top-1/2 left-0 z-[2] -translate-x-1/2 -translate-y-1/2 shadow-[inset_0_0_0_1px_rgba(0,0,0,0.1),0_1px_2px_0_rgba(0,0,0,0.8)] focus-visible:outline-0 focus-visible:ring-2 ring-indigo-500 data-[is-target="true"]:z-[3]',
        tooltip:
    ...
    taglist: {
        ...
        tagWrapper:
            'mr-1 focus:outline-none focus:text-white [&>div]:focus:bg-indigo-500 [&>div>button]:focus:text-white',
        tagLabel: 'pl-2 pr-1',
    ...
    toggle: {
        ...
        track:
            'p-0.5 min-w-[3em] relative rounded-full transition-all bg-gray-400 peer-checked:bg-indigo-500 peer-checked:[&>div:last-child]:left-full peer-checked:[&>div:last-child]:-translate-x-full peer-checked:[&>div:first-child:not(:last-child)]:left-0 peer-checked:[&>div:first-child:not(:last-child)]:translate-x-0',
